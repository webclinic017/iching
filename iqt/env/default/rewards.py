...
from iqt.env.generic import RewardScheme, TradingEnv
from iqt.feed.core import Stream, DataFeed
import math


class iqtRewardScheme(RewardScheme):
    ...
    def get_reward(self, portfolio) -> float:
        ...
        ----------
        portfolio : `Portfolio`
            The portfolio associated with the `iqtActionScheme`.
...
class SimpleProfit(iqtRewardScheme):
...
class RiskAdjustedReturns(iqtRewardScheme):
...
def get(identifier: str) -> 'iqtRewardScheme':

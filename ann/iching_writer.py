...
class IchingWriter(object):
    ...
    def add_scalar(self, tag: str, scalar_value: 'Any', global_step: int, walltime: float) -> None:
        print('add_scalar: {0}={1} {2};'.format(tag, scalar_value, global_step))

    def add_scalars(self, main_tag: str, tag_scalar_dict: dict, global_step: int, walltime: float) -> None:

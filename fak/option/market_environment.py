...
class MarketEnvironment(object):
    ...
    def __init__(self, name: str, pricing_date: datetime) -> None:
        self.name = name
    ...
    def add_constant(self, key: str, constant: 'Any') -> None:
    ...
    def add_environment(self, env: 'MarketEnvironment') -> None:

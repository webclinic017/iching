...
from iqt.oms.orders import TradeSide
from iqt.env.generic import Renderer, TradingEnv
...
class PlotlyTradingChart(BaseRenderer):
    """Trading visualization for iqt using Plotly.
...
class MatplotlibTradingChart(BaseRenderer):
    """ Trading visualization for iqt using Matplotlib
    Parameters
    ---------
    display : bool
        True to display the chart on the screen, False for not.

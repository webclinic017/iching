...
from fak.option.simulation_base import SimulationBase
...
class JumpDiffusion(SimulationBase):
    ...
    def generate_paths(self, fixed_seed=False, day_count=365.):
        ...
        if self.correlated is False:
            ...
            sn1 = RandomNumberGenerator.sn_random_numbers((1, M, I),
        ...
        sn2 = RandomNumberGenerator.sn_random_numbers((1, M, I),
                                fixed_seed=fixed_seed)
